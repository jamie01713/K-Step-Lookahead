...
from policies.Online_Multiple_Step import LG1T,LG2T,LG1_2T,LG1TU,LG1T_I,LG1_2T_Adaptive,LG2TU
...
def main(n_state=10,n_action=5,n_experiments=1000,n_replications_per_experiment=1,n_horizon=20000,name_policies={LG1T:{"threshold":0.3}, LG2T:{"threshold": 0.9,"power":1/2}},entropy=243799254704924441050048792905230269161,model_type="discrete"):
    ...
    data_pkl = os.path.join(path, f"data__{tag}_synthetic_uniform.pkl")
    ...
    for e in range(n_experiments):
        ...
        model=MDP_100(n_states=n_state,n_actions=n_action,entropy=sq[e,0])
    ...
    plt.tight_layout()
    plt.savefig(f"{tag}_synthetic_uniform.pdf", bbox_inches="tight")
    plt.show()
...
if __name__ == "__main__":
    ...
    # parser.add_argument("--name_policies",type=object,default={LG1T:{"threshold":0.3},LG2T:{"threshold": 0.9,"power":1/2},LG1_2T:{"threshold":0.9,"threshold_i":0.3,"power":1/2,"cutoff":3000},EVI_based:{ "config": [EVI_based.prefabs["UCRL2"],EVI_based.prefabs["KLUCRL"],EVI_based.prefabs["PMEVI-KLUCRL"]]},Optimistic_Q_Learning: {"gamma": [0.9,0.99],"T": 20000},Q_learning:{"delta":0.01,"n_horizon": [1,10], "T":20000},MDP_OOMD:{"B":4,"N":2,"T":20000}})   
    # parser.add_argument("--name_policies",type=object,default={LG1T:{"threshold":0.3},LG1TU:{"threshold": 0.3}})    
    # parser.add_argument("--name_policies",type=object,default={LG1T:{"threshold":0.3},LG2T:{"threshold":0.9,"power":1/2},LG1_2T:{"threshold":0.9,"threshold_i":0.3,"power":1/2,"cutoff":[10000]}})    
    # parser.add_argument("--name_policies",type=object,default={LG1T:{"threshold":[0.3]},LG2T:{"threshold":0.9,"power":1/2}, LG1_2T:{"threshold":[0.9],"threshold_i":0.3,"power":1/2,"cutoff":100}}) 
    # parser.add_argument("--name_policies",type=object,default={LG2T:{"threshold":0.9,"power":1/2}}) 
    parser.add_argument("--name_policies",type=object,default={LG1T:{"threshold":0.3},LG1TU:{"threshold":[0.3,1.3,2.3,3.3]},LG2T:{"threshold":0.9,"power":1/2},LG2TU:{"threshold":[0.9,2.9,4.9,6.9],"power":1/2}})  
    # parser.add_argument("--name_policies",type=object,default={LG1T:{"threshold":[0.0,0.3,1.5]},LG1T_I:{"threshold":[0.0],"T_max":20000}})   
